...
class JobSeekerExperienceController extends Controller
{
   ...
   public function index(Request $request) {
        if($request->page) {
            ...
            $datas = \App\JobSeekerExperience::orderBy('type','asc')->get();
        }
    ...
    {
        $data = JobSeekerExperience::find($id);

        if (!$data) {
            return response()->json([
                'success' => false,
                'message' => 'JobSeekerExperience with id ' . $id . ' not found'
            ], 400);
        }
        ...
        if ($updated)
            ...
            return response()->json([
                'success' => false,
                'message' => 'JobSeekerExperience could not be updated'
            ], 500);
    }
    ...
    public function destroy($id)
    {
        ...
        if ($data->delete()) {
            ...
            return response()->json([
                'success' => false,
                'message' => 'JobSeekerExperience could not be deleted'
            ], 500);
        }
    }
}
