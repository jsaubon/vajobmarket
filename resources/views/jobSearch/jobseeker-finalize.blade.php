    ...
    <div class="container d-flex flex-column justify-content-center h-100  w-50 pl-4" style="max-width:600px">
        ...
        <div class="row" style="margin-top: 20%;">
            <div class="container-fluid py-2 d-flex justify-content-center ">
                ...
                <a href="/jobseekerDashboard" class="btn btn-light back-btn mx-2  d-flex flex-column justify-content-center" style="width: 120px; height: 30px; font-size:8px !important">
                    skip to dashboard
                </a>
            </div>
        </div>
