...
$(document).ready(function() {
    ...
    function createJobSeekerExperiences(data_experiences) {
        postData('/api/JobSeekerExperience',data_experiences, ({data:res}) => {
            if(res.success) {
                ...
                alert('Profession Successfully Saved');
                location.reload();
            }
        });
    }
    ...
    $('body').on('click','.btn_add_language', function() {
        let rows = $('.languages_container').find('.row').length;
    ...
    $('body').on('click','.btn_add_experience', function() {
        let rows = $('.experiences_container').find('.row').length;
