    ...
    <div class="container h-auto fullwidth">
        <!-- Content Sart -->
            ...
            <div class="card-w-100 h-100" >
                <div class="card-header bg-white" style="min-height: 70vh;">

                    <!-- NavTabs List Start -->
                    <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
                        <li class="nav-item m-0">
                            <a class="nav-link active title-personal-info m-0 active-bottom border border-bottom-1 border-top-0 border-2  border-left-0 border-right-0  text-center text-dark" id="boInbox-tab" data-toggle="tab" href="#boInbox" role="tab" aria-controls="boInbox" aria-selected="true">Inbox</a>
                        </li>
                        <li class="nav-item m-0">
                            <a class="nav-link title-personal-info m-0 active-bottom border border-bottom-1 border-top-0 border-2  border-left-0 border-right-0  text-center text-dark" id="boOutBox-tab" data-toggle="tab" href="#boOutBox" role="tab" aria-controls="boOutBox" aria-selected="false">Outbox</a>
                        </li>
                    </ul>
                    <!-- NavTabs List End -->
